...
class CommonLocalizations {
  ...
  static Future<CommonLocalizations> load(Locale locale) {
    ...
    return initializeMessages(localeName).then((_) {
      ...
      final instance = CommonLocalizations._internal();
      return instance;
    });
  }
  ...
  static CommonLocalizations of(BuildContext context) {
    final instance =
        Localizations.of<CommonLocalizations>(context, CommonLocalizations);
...
class _AppLocalizationDelegate
  ...
  @override
  bool isSupported(Locale locale) => CommonLocalizations.supportedLocales.any(
